const CONFIG = {
    ...
    desc: 'Và giá như anh có thể anh sẽ làm tất cả vì em. Làm người yêu em nhé <3 ! Babe ❤️',
    ket:'(Nếu không trả lời mà thoát ra là anh yêu em đấy nhá :3)',
    btnYes: 'Đồng ý luôn <3',
    btnNo: 'Không yêu :3',
    question:'Thật tuyệt ! Khi cả hai ta cùng thích nhau. Em rất muốn biết tại sao anh thích em ?',
    btnReply: 'Gửi cho em <3',
    reply: 'Em cũng yêu anh ạ',
    mess: 'Em biết mà 🥰 Em yêu anh nhiều lắm 😘😘',
    //mess:':3 Hihi',
    //messDesc: 'Tối nay 7h anh qua đón nhé công chúa.',
    messDesc:'Vậy còn ngần ngại gì nữa 🥰 Trò chuyện cùng anh thôi nào, gét gô',
